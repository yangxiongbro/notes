...
<mapper namespace="mapper.package">
    ...
    <resultMap id="resultMapId" type="vo.package">
        ...
        <association property="wife" javaType="wife.vo.package">
            <result column="R_PATROL_CYCLE" jdbcType="VARCHAR" property="patrolCycle"/>
            <result column="R_PATROL_MODE" jdbcType="VARCHAR" property="patrolMode"/>
            <result column="R_COMPLETE_TYPE" jdbcType="VARCHAR" property="completeType"/>
            <result column="R_ACCURATE_TYPE" jdbcType="VARCHAR" property="accurateType"/>
            <result column="R_ON_TIME_TYPE" jdbcType="VARCHAR" property="onTimeType"/>
            <result column="R_COMPLETE_TARGET" jdbcType="VARCHAR" property="completeTarget"/>
            <result column="R_COMPLETE_RESULT" jdbcType="VARCHAR" property="completeResult"/>
            <result column="R_COMPLETE_ISSUE_POSITION" jdbcType="VARCHAR" property="completeIssuePosition"/>
            <result column="R_ACCURATE_TARGET" jdbcType="VARCHAR" property="accurateTarget"/>
            <result column="R_ACCURATE_RESULT" jdbcType="VARCHAR" property="accurateResult"/>
            <result column="R_ACCURATE_ISSUE_POSITION" jdbcType="VARCHAR" property="accurateIssuePosition"/>
            <result column="R_ON_TIME_TARGET" jdbcType="VARCHAR" property="onTimeTarget"/>
            <result column="R_ON_TIME_RESULT" jdbcType="VARCHAR" property="onTimeResult"/>
            <result column="R_ON_TIME_ISSUE_POSITION" jdbcType="VARCHAR" property="onTimeIssuePosition"/>
            <result column="R_CITY_DIMENSION" jdbcType="VARCHAR" property="cityDimension"/>
            <result column="R_GRANULARITY" jdbcType="VARCHAR" property="granularity"/>
            <result column="R_BUSINESS_DIMENSION" jdbcType="VARCHAR" property="businessDimension"/>
            <result column="R_REMARK" jdbcType="VARCHAR" property="remark"/>
            <result column="R_CREATED_TIME" jdbcType="DATE" property="createdTime"/>
            <result column="R_UPDATE_TIME" jdbcType="DATE" property="updateTime"/>
        </association>
        <collection property="tableList" column="{MODULE_ID=ID, ENV=ENV}" javaType="ArrayList"
                    select="listModuleTable" />
        <collection property="granularityList" column="{MODULE_ID=ID, ENV=ENV}" javaType="ArrayList"
                    select="listModuleGranularity" />
        <collection property="zoneList" column="{MODULE_ID=ID, ENV=ENV}" javaType="ArrayList"
                    select="listModuleZone" />
        <collection property="appsubList" column="{MODULE_ID=ID, ENV=ENV}" javaType="ArrayList"
                    select="listModuleAppsub" />
    </resultMap>
    ...
    <select id="list" resultMap="resultMapId">
        select
            module_join.ID,
            module_join.NAME,
            module_join.PATROL_DIMENSION_TYPE,
            module_join.COMPLETE_STATIC_TYPE,
            module_join.ACCURATE_STATIC_TYPE,
            module_join.ON_TIME_STATIC_TYPE,
            module_join.DAY_OFFSET,
            module_join.ENV,
            module_join.REMARK,
            module_join.STATUS,
            module_join.CREATED_TIME,
            module_join.UPDATE_TIME,
            remark_join.PATROL_CYCLE        AS R_PATROL_CYCLE,
            remark_join.PATROL_MODE         AS R_PATROL_MODE,
            remark_join.COMPLETE_TYPE       AS R_COMPLETE_TYPE,
            remark_join.ACCURATE_TYPE       AS R_ACCURATE_TYPE,
            remark_join.ON_TIME_TYPE        AS R_ON_TIME_TYPE,
            remark_join.COMPLETE_TARGET     AS R_COMPLETE_TARGET,
            remark_join.COMPLETE_RESULT     AS R_COMPLETE_RESULT,
            remark_join.COMPLETE_ISSUE_POSITION AS R_COMPLETE_ISSUE_POSITION,
            remark_join.ACCURATE_TARGET     AS R_ACCURATE_TARGET,
            remark_join.ACCURATE_RESULT     AS R_ACCURATE_RESULT,
            remark_join.ACCURATE_ISSUE_POSITION AS R_ACCURATE_ISSUE_POSITION,
            remark_join.ON_TIME_TARGET      AS R_ON_TIME_TARGET,
            remark_join.ON_TIME_RESULT      AS R_ON_TIME_RESULT,
            remark_join.ON_TIME_ISSUE_POSITION AS R_ON_TIME_ISSUE_POSITION,
            remark_join.CITY_DIMENSION      AS R_CITY_DIMENSION,
            remark_join.GRANULARITY         AS R_GRANULARITY,
            remark_join.BUSINESS_DIMENSION  AS R_BUSINESS_DIMENSION,
            remark_join.REMARK              AS R_REMARK,
            remark_join.CREATED_TIME        AS R_CREATED_TIME,
            remark_join.UPDATE_TIME         AS R_UPDATE_TIME
        from D_HX_AP_MODULE module_join
        left join D_HX_AP_MODULE_REMARK remark_join
            on module_join.ID=remark_join.MODULE_ID
            and module_join.env=remark_join.env
        where module_join.status=1 and module_join.env=#{env}
        order by module_join.ID asc
    </select>
</mapper>
```
...
![](./note/pictures/bg2015120901.png)
