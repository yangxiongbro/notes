...
```sql
SELECT * from gar_resources where id>795 ORDER BY id  desc;
SELECT * from gar_permissions where id>777 ORDER BY id  desc;
SELECT * from gar_permissions_resources where permission_id>777 ORDER BY permission_id  desc;
```
