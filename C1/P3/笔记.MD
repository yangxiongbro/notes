...
```sql
SELECT * from gar_resources where id>775 ORDER BY id  desc;
SELECT * from gar_permissions where id>757 ORDER BY id  desc;
SELECT * from gar_permissions_resources where permission_id>757 ORDER BY permission_id  desc;
```
...
from(
    ...
    left join(
        select
            ...
            roles_permissions_join.permission_name as permission_name
