...
https://blog.51cto.com/u_15127579/4169290

https://zhuanlan.zhihu.com/p/97555913

http://events.jianshu.io/p/5fb3f0cc1461

[springboot和springframework版本依赖关系 (xbhp.cn)](http://www.xbhp.cn/news/40230.html)
...
[Spring boot ResponseBodyAdvice接口全局统一返回控制，Api返回值是String 类型时异常_responsebodyadvice 统一返回_Crystalqy的博客-CSDN博客](https://blog.csdn.net/Crystalqy/article/details/129285988)

[Spring中ResponseBodyAdvice的使用详解_java_脚本之家 (jb51.net)](https://www.jb51.net/article/226704.htm)
...
//        objectMapper.setDefaultPropertyInclusion(JsonInclude.Include.NON_NULL);
        ...
        simpleModule.addSerializer(JdbcClob.class, new JacksonJdbcClobSerializer());
        simpleModule.addSerializer(BufferedReader.class, new JacksonBufferedReaderSerializer());
        simpleModule.addSerializer(ByteArrayInputStream.class, new JacksonByteArrayInputStreamSerializer());
        //json值反序列化
