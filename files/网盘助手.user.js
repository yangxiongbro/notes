...
(function () {
    ...
    container.define("api", ["http", "env", "share_log", "snap", "object", "constant"], function (http, env, shareLog, snap, object, constant) {
        var obj = {
    ...
    container.define("app_baidu", ["runtime", "config", "option", "logger", "unsafe_window", "constant", "core", "api", "$"], function (runtime, config, option, logger, unsafeWindow, constant, core, api, $) {
        ...
        obj.showDownloadSelect = function (fileList, fileStat) {
            ...
            body += '<div class="normalBtnBox g-center"><a class="g-button g-button-large g-button-gray-large nd-button-pack"><span class="g-button-right"><em class="icon icon-download"></em> 压缩包</span></a>';
            body += '<a class="g-button g-button-large g-button-gray-large nd-button-multi" style="margin-left:50px;"><span class="g-button-right"><em class="icon icon-poly"></em> 多文件</span></a></div>';
        ...
        obj.renderFooterAppId = function () {
            return '<p style="padding-top: 10px; border-top: 1px solid #D0DFE7;">当前应用ID：' + obj.getAppId() + ' <a href="javascript:;" class="nd-change-app-id">修改</a>，其他设置请访问 <a class="nd-open-page-option" href="javascript:;">配置页面</a></p>';
        };
